...
Package: 0.1.0-slate7.5. Development checks completed 2026-09-23.
...
- All 31 AxisBridge backend/protocol tests passed, including UDP unicast/multicast, independent local-IP binding, simulated MA login/output, automatic PSN/MA startup, saved owner-only credentials, demo output, loss of input, and reconnection.
